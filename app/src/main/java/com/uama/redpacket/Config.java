...
public class Config {
    ...
    public static final String KEY_ENABLE_WECHAT_ONLY_GROUP = "KEY_ENABLE_WECHAT_ONLY_GROUP";
    ...
    public static final String KEY_Self_Close_Enable = "KEY_Self_Close_Enable";
    ...
    public void setEnableWechat(boolean enableWechat){
        preferences.edit().putBoolean(KEY_ENABLE_WECHAT, enableWechat).apply();
    }

    public boolean isOnlyEnableWechatGroup() {
        return preferences.getBoolean(KEY_ENABLE_WECHAT_ONLY_GROUP, false) ;
    }

    public void setOblyEnableWechatGroup(boolean oblyEnableWechatGroup){
        preferences.edit().putBoolean(KEY_ENABLE_WECHAT_ONLY_GROUP, oblyEnableWechatGroup).apply();
    }
    ...
    public void setSelfCloseDetailEnable(boolean enable) {
        preferences.edit().putBoolean(KEY_Self_Close_Enable, enable).apply();
    }

    public boolean getSelfCloseDetailEnable() {
        return preferences.getBoolean(KEY_Self_Close_Enable, true);
    }
